...
public class BijoyFontUtil {
    ...
    public static String convertUnicode2BijoyString(String text) {
    ...
    private static String postConversion(String text) {
            text = text.replace("।", "|");
            text = text.replace("‘", "Ô");
            text = text.replace("’", "Õ");
            text = text.replace("“", "Ò");
            ...
            text = text.replace("ড়", "o");
            text = text.replace("ঢ়", "p");
            text = text.replace("য়", "q");
    ...
    private static String preConversion(String text) {
            text = text.replaceAll("ো", "ো");
            text = text.replaceAll("ৌ", "ৌ");
            return text;
    } // end function preConversion

    private static String reArrangeUnicodeText(String str) {
            int barrier = 0;
    ...
    private static boolean isBanglaDigit(char CUni) {
    ...
    private static boolean isBanglaPreKar(char CUni) {
    ...
    private static boolean isBanglaPostKar(char CUni) {
    ...
    private static boolean isBanglaKar(char CUni) {
    ...
    private static boolean isBanglaBanjonborno(char CUni) {
    ...
    private static boolean isBanglaHalant(char CUni) {
            if (CUni == '্')
                    return true;
